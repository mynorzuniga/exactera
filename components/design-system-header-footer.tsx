 ...
 * - **Primary CTA**: label **Speak to an Expert**; **Body Big** bold (**1.125rem**), **mint 600** idle / **700** + stronger glow on **hover**, white text, trailing **ArrowRightIcon** (see `lib/ds-cta-interaction.ts` / `SpeakToExpertPrimaryCtaButton`). On **viewport &lt; `lg` (1024px)** the CTA moves into the **mobile drawer** footer; the top bar shows **Search**, **Account**, and **Menu** (hamburger) only.
 *
 * ## Header V1 — mobile (&lt; `lg`)
 *
